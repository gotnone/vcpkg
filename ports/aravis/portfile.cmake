...
file(REMOVE ${CURRENT_PACKAGES_DIR}/debug/bin/arv-camera-test-0.8${VCPKG_TARGET_EXECUTABLE_SUFFIX})
file(REMOVE ${CURRENT_PACKAGES_DIR}/debug/bin/arv-fake-gv-camera-0.8${VCPKG_TARGET_EXECUTABLE_SUFFIX})
file(REMOVE ${CURRENT_PACKAGES_DIR}/debug/bin/arv-test-0.8${VCPKG_TARGET_EXECUTABLE_SUFFIX})
file(REMOVE ${CURRENT_PACKAGES_DIR}/debug/bin/arv-tool-0.8${VCPKG_TARGET_EXECUTABLE_SUFFIX})

file(MAKE_DIRECTORY ${CURRENT_PACKAGES_DIR}/tools/${PORT})
file(RENAME ${CURRENT_PACKAGES_DIR}/bin/arv-camera-test-0.8${VCPKG_TARGET_EXECUTABLE_SUFFIX} ${CURRENT_PACKAGES_DIR}/tools/${PORT}/arv-camera-test-0.8${VCPKG_TARGET_EXECUTABLE_SUFFIX})
...
file(RENAME ${CURRENT_PACKAGES_DIR}/bin/arv-test-0.8${VCPKG_TARGET_EXECUTABLE_SUFFIX} ${CURRENT_PACKAGES_DIR}/tools/${PORT}/arv-test-0.8${VCPKG_TARGET_EXECUTABLE_SUFFIX})
